        ...
        return function() {
            ...
            var b = function(e) {
                ...
                return d(i, [{
                    ...
                    value: function(e) {
                        var t = this;
                        if (this.options.createImageThumbnails  && e.size <= 1024 * this.options.maxThumbnailFilesize * 1024) return this._thumbnailQueue.push(e), setTimeout((function() {
                    ...
                    value: function(e, t, n, r, i, o) {
                        ...
                        u.onload = function() {
                            ...
                            var blob = new Blob([u.result], {type: e.type});
                            ...
                            video.addEventListener('loadeddata', function() {
                              ...
                              var snapImage = function() {
                               ...
                               if (success) {
                                  console.log("what happne?");
                                  URL.revokeObjectURL(url);
                                  console.log(image);
                                  e.dataURL = image, "image/svg+xml" !== e.type ? a.createThumbnailFromUrl(e, t, n, r, i, o, image, image) : null != o && o(u.result)
                                }
                              ...
                              video.play(); 
                                ...
                                e.dataURL = u.result, "image/svg+xml" !== e.type ? a.createThumbnailFromUrl(e, t, n, r, i, o, "ass") : null != o && o(u.result)
                            }
                            
                        }, e.type.includes("video") ? u.readAsArrayBuffer(e) : u.readAsDataURL(e)
                    ...
                    value: function(e, t, n, r, i, o, a, image, murder) {
                        var u = this,
                        ...
                        }, null != o && (s.onerror = o), s.src = image
                    }
                }, {
                    key: "processQueue",
                    value: function() {
                                    ...
                                    if (!(n >= o.upload.totalChunkCount)) {
                                        var r = n * t.options.chunkSize,
                                            ...
                                            s = {
                                                ...
                                                filename: o.upload.filename.replace(/\s/g, ""),
                                                chunkIndex: n
                                            };
                                        o.upload.chunks[n] = {
                                            file: o,
