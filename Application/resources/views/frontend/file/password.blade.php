...
@section('section_class', 'mt-auto')
@section('section', lang('Password', 'image password'))
@section('title', $fileEntry->name)
@section('content')
    <div class="container-lg">
        <div class="section-inner">
            <div class="section-body">
                <div class="card-v v2 col-12 col-sm-12 col-md-6 col-xl-4 mx-auto">
                    <div class="card-v-body">
                        <div class="file-password">
                            <div class="file-password-img">
                                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="866.52362"
                                    height="637.05628" viewBox="0 0 866.52362 637.05628"
                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <path d="M971.73819,768.52814v-72.34S999.92985,747.47411,971.73819,768.52814Z"
                                        transform="translate(-166.73819 -131.47186)" fill="#f1f1f1" />
                                    <path d="M973.47966,768.51541,920.19,719.59417S977.03523,733.5097,973.47966,768.51541Z"
                                        transform="translate(-166.73819 -131.47186)" fill="#f1f1f1" />
                                    <path
                                        ...
                                        transform="translate(-166.73819 -131.47186)" fill="#ffb7b7" />
                                    <polygon
                                    ...
                                    <path
                                        ...
                                        transform="translate(-166.73819 -131.47186)" fill="#2f2e41" />
                                    <polygon
                                    ...
                                    <path
                                        ...
                                        transform="translate(-166.73819 -131.47186)" fill="#cbcbcb" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-166.73819 -131.47186)" fill="#2f2e41" />
                                    <path d="M594.90728,516.06962,272.80489,604.901,166.73819,220.3032l322.10239-88.83134Z"
                                        transform="translate(-166.73819 -131.47186)" fill="#fff" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-166.73819 -131.47186)" fill="#e5e5e5" />
                                    <path
                                        ...
                                        transform="translate(-166.73819 -131.47186)" class="icon-color" />
                                    <rect x="263.48929" y="361.96862" width="233.72825" height="9.03209"
                                        transform="translate(-250.48374 -17.16149) rotate(-15.41811)" fill="#f1f1f1" />
                                    <rect x="269.75017" y="384.67055" width="233.72825" height="9.03209"
                                        transform="translate(-256.29398 -14.67996) rotate(-15.41811)" fill="#f1f1f1" />
                                    <rect x="276.01104" y="407.37248" width="233.72825" height="9.03209"
                                        transform="translate(-262.10422 -12.19843) rotate(-15.41811)" fill="#f1f1f1" />
                                    <rect x="287.03019" y="447.32789" width="233.72825" height="9.03209"
                                        transform="translate(-272.33023 -7.83093) rotate(-15.41811)" fill="#f1f1f1" />
                                    <rect x="293.29106" y="470.02982" width="233.72825" height="9.03209"
                                        transform="translate(-278.14047 -5.34939) rotate(-15.41811)" fill="#f1f1f1" />
                                    <rect x="299.55194" y="492.73176" width="233.72825" height="9.03209"
                                        transform="translate(-283.9507 -2.86786) rotate(-15.41811)" fill="#f1f1f1" />
                                    <path d="M698.0144,603.61617H363.88724V204.66055H698.0144Z"
                                        transform="translate(-166.73819 -131.47186)" fill="#fff" />
                                    <path
                                        d="M698.0144,603.61617H363.88724V204.66055H698.0144Zm-328.23263-5.89454H692.11986V210.55508H369.78177Z"
                                        transform="translate(-166.73819 -131.47186)" fill="#e5e5e5" />
                                    <rect x="279.40817" y="244.69464" width="191.03421" height="9.03209"
                                        class="icon-color" />
                                    <rect x="279.40817" y="268.17807" width="191.03421" height="9.03209"
                                        class="icon-color" />
                                    <rect x="279.40817" y="291.66149" width="191.03421" height="9.03209"
                                        class="icon-color" />
                                    <circle cx="263.87741" cy="250.53394" r="5.89453" class="icon-color" />
                                    <rect x="279.40817" y="143.50512" width="191.03421" height="9.03209"
                                        fill="#e5e5e5" />
                                    <rect x="279.40817" y="166.98855" width="191.03421" height="9.03209"
                                        fill="#e5e5e5" />
                                    <rect x="279.40817" y="190.47198" width="191.03421" height="9.03209"
                                        fill="#e5e5e5" />
                                    <circle cx="263.87741" cy="148.36201" r="5.89453" fill="#e5e5e5" />
                                    <rect x="279.40817" y="346.86657" width="191.03421" height="9.03209"
                                        fill="#e5e5e5" />
                                    <rect x="279.40817" y="370.35" width="191.03421" height="9.03209"
                                        fill="#e5e5e5" />
                                    <rect x="279.40817" y="393.83343" width="191.03421" height="9.03209"
                                        fill="#e5e5e5" />
                                    <circle cx="263.87741" cy="351.72346" r="5.89453" fill="#e5e5e5" />
                                    <circle cx="515.67691" cy="438.20509" r="68.29339" class="icon-color" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        transform="translate(-166.73819 -131.47186)" class="icon-color" />
                                    <path d="M1032.26181,768.12193h-381a1,1,0,0,1,0-2h381a1,1,0,0,1,0,2Z"
                                        transform="translate(-166.73819 -131.47186)" fill="#cbcbcb" />
                                </svg>
                            </div>
                            <div class="file-password-form">
                                <form action="{{ route('file.password', $fileEntry->shared_id) }}" method="POST">
                                    @csrf
                                    <label
                                        class="form-label mb-3">{{ lang('Enter the password to unlock the image', 'image password') }}
                                    </label>
                                    <div class="input-group input-icon input-password mb-3">
                                        <input type="password" name="password" class="form-control form-control-md"
                                            placeholder="{{ lang('Enter password', 'image password') }}" required>
                                        <button type="button" id="input-group-button-right">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                    </div>
                                    <button
                                        class="btn btn-primary btn-md w-100">{{ lang('Unlock', 'image password') }}</button>
                                </form>
                            </div>
                        </div>
                    </div>
