<div class="uploadbox">
    ...
    <div class="uploadbox-content">
        <div class="uploadbox-header">
            <p class="h5 mb-0">{{ lang('Upload Your Images', 'upload zone') }}</p>
        ...
        <div class="uploadbox-body">
            <div class="uploadbox-body-header">
                <div class="d-flex text-muted small">
                    <span>
                        {!! str_replace('{max_file_size}', '<strong>' . uploadSettings()->formates->file_size . '</strong>',lang('Max Image Size {max_file_size}', 'upload zone')) !!}
                        <span>/</span>
                        {!! str_replace('{files_duration}','<strong>' . uploadSettings()->formates->files_duration . '</strong>',lang('Images available for {files_duration}', 'upload zone')) !!}
                    </span>
                </div>
            ...
            <div class="uploadbox-body-content">
                <div class="uploadbox-drag" data-dz-click>
                    <div class="uploadbox-drag-inner">
                        ...
                        <h3>{{ lang('Drag and drop your images here to upload', 'upload zone') }}</h3>
                        <p class="mb-0">
                ...
                <div class="uploadbox-wrapper">
                                        ...
                                        <div class="dz-file-edit-box-body text-center" data-simplebar>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <p class="mb-0 text-muted small">
                                                    {{ lang('The password helps protect your images from public accessing', 'upload zone') }}
                                                </p>
                                            </div>
                                            <div class="mb-3">
                    ...
                    <div class="uploadbox-wrapper-form mt-4">
                        <div class="mb-3">
							  <input type="checkbox" id="safe" class="nsfw" name="work" value="checked">
                              <label for="safe"> NSFW</label><br>
                            
                              @if((Auth::user()) and is_file(storage_path("app/public/" . "/uploads/users/" . hashid(userAuthInfo()->id) . "/" . "watermark.jpg")))
                              <select id="dmca" class="dmca" name="work">
  ...
  <option value="upper-right">upper-right</option>
                              ...
                              <label for="dmca"> Add dmca badge</label><br>  
							  <select name="watermark" id="logo" class="watermark" onchange="showSelect()">
  <option value="None">None</option>
  <option value="bottom-left">bottom-left</option>
  <option value="bottom-right">bottom-right</option>
  <option value="upper-left">upper-left</option>
  <option value="upper-right">upper-right</option>
                              ...
                              <label for="logo"> Add custom watermark to image</label><br> 

                              <select name="watermarkSize" id="size" class="size" style="display: none;">
...
<script>
function showSelect() {
  var firstSelect = document.getElementById('logo');
  var secondSelectContainer = document.getElementById('size');

  // Check if Option 1 is selected in the first select
  if (firstSelect.value != 'None') {
    secondSelectContainer.style.display = 'block'; // Show the second select
  } else {
    secondSelectContainer.style.display = 'none'; // Hide the second select
  }
}
...
<div class="dz-dragbox">
    <div class="dz-dragbox-inner">
        ...
        <h2 class="my-4">{{ lang('Drop Your Image Here', 'upload zone') }}</h2>
        <h3>{{ lang('Add your images by drag-and-dropping them on this window 😉', 'upload zone') }}</h3>
    </div>
</div>
@push('scripts_libs')
    ...
    <script>
        ...
        const uploadConfig = {
            ...
            translation: {
                ...
                redditLink: "<?php echo e(lang('Reddit Link', 'upload zone')); ?>",
                htmlCode:"{{ lang('HTML Code', 'upload zone') }}",
                copy:"{{ lang('Copy', 'upload zone') }}",
