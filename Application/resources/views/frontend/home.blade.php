            ...
            <div class="container-lg">
                <div class="wrapper-content">
                    ...
                    <div data-aos="fade-right" data-aos-duration="1000">
                        <h2 class="text-center mb-3">{{ lang('Upload And Share Your Images', 'home page') }}</h2>
                    </div>
                    <div class="text-center col-md-8 col-lg-7 col-xl-7" data-aos="fade-right" data-aos-duration="1000"
                        data-aos-delay="300">
                        <p class="lead mb-4">
                            {{ lang('Drag and drop anywhere or click to upload your (JPG JPEG PNG BMP GIF WEBP) images and start sharing them everywhere for free.', 'home page') }}
                        </p>
                    </div>
